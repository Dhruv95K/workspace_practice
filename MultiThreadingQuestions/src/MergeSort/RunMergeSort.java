...
public class RunMergeSort {
    public static void main(String[] args) {
        ...
        MultiThreadedMergeSort multiThreadedMergeSort = new MultiThreadedMergeSort(arrayToSort);
        int[] sortedArrayMT = multiThreadedMergeSort.returnSortedArray();
        multiThreadedMergeSort.getTimeTaken();
